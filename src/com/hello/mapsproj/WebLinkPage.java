...
public class WebLinkPage extends Activity
{
	...
	String index,filerec;
	TextView tv1,tvaddr,tvlink;	
	String myadd[];
	Address add;
	ImageView imgv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.web_link_page);
		...
		filerec=ii.getStringExtra("file");
		if(filerec.equals("cinema"))
			tvlink.setText("in.bookmyshow.com/vadodara");
		else
			tvlink.setText(filerec);
